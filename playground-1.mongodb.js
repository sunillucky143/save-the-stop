...
db.getCollection('Orange').insertMany([
 ...
 db.getCollection('Kiwi').insertMany([
  ...
  {'seq_id':1,'route':'Kiwi','direction_id':0,'stops':{'stop_id':34,'stop_name':'Rock Bus Stop','location':{'lat':88.21540488018111,'long':3.4482589462671127,'initial_stop':0,'final_stop':0,'time_arrival':'7:17 a.m.','time_departure':'7:17 a.m.'}}},
  {'seq_id':1,'route':'Kiwi','direction_id':0,'stops':{'stop_id':35,'stop_name':'Vintage House Bus Stop','location':{'lat':88.21410439685839,'long':5.261071859794709,'initial_stop':0,'final_stop':0,'time_arrival':'7:22 a.m.','time_departure':'7:22 a.m.'}}},
